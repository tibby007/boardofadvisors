 ...
 * to respond based on their domains of expertise and priority rules.
 */
...
/**
 * Selects the most relevant advisors based on the question
 * @param {string} question - The user's question
 * @returns {Object} - JSON object with selected advisors
 */
...
// Export the function for use in Factory
module.exports = {
  routeQuestion
};
